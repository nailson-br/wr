...
<body>
  <div class="container-fluid">
  	<div class="row">
        ...
        <form class="form-horizontal" action="{{ url('create-cod_service')}}" method="post" enctype="multipart/form-data">
          {!! csrf_field() !!}
        <fieldset>

          <!-- Form Name -->
          <legend>Cadastro de Códigos de Serviço</legend>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input id="description" name="description" type="text" placeholder="Descrição do código do serviço" class="form-control input-md" required="" data-error="deu merda">
