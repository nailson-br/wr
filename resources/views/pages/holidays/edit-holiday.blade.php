...
<body>
  <div class="container-fluid">
  	<div class="row">
        ...
        <form class="form-horizontal" action="{{ url('edit-holiday/' . $holiday->id)}}" method="post" enctype="multipart/form-data">
          {!! csrf_field() !!}
        <fieldset>

          <!-- Form Name -->
          <legend>Editar Feriado ou Dia-Ponte</legend>
          ...
          <div class="form-group">
            ...
            <div class="input-group date col-md-5" style="padding-left: 15px ;padding-right: 15px;">
                <input id="holiday" name="holiday" type="text" placeholder="dd/mm/aaaa" class="form-control" readonly="" oninvalid="this.setCustomValidity('Insira a data do feriado.')" oninput="setCustomValidity('')" value="{!! date_format(date_create_from_format('Y-m-d', $holiday->holiday), 'd/m/Y') !!}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <input id="description" name="description" type="text" placeholder="Descrição" class="form-control input-md" required="" data-error="deu merda" value="{!! $holiday->description !!}">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <select id="holiday_type" name="holiday_type" class="form-control">
                <option value="holiday" {{ $holiday->holiday_type === "holiday" ? "selected" : "" }}>feriado</option>
                <option value="bridge" {{ $holiday->holiday_type === "bridge" ? "selected" : "" }}>dia-ponte</option>
              </select>
            </div>
          </div>
